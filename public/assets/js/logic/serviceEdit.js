	...
	{	  
		return(
				<form action={this.props.url} className="form-horizontal" method="post" onSubmit={this.handleSubmit}>
				  ...
				  <FormGroup label="Port" name="port" value="" type="text"/> 
				  <FormGroup label="Peace time" name="peaceTime" value="" type="text"/> 
				  <FormGroupSelect label="User" name="userID"  display="name"  value="2"  url="" />
				  <FormGroupSelect label="Service Group" name="serviceGroupID"  display="name"  value="2"  url="" />
				  <FormGroupSelect label="Server" name="serverID"  display="name"  value="2"  url="" />
				  <FormGroupSelect label="Market" name="marketID"  display="name"  value="2"  url="" />
				  <SubmitButton />
			   </form>
		);
	}
